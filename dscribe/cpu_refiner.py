...
from dscribe.saicinpainting.evaluation.data import pad_tensor_to_modulo
...
from dscribe.saicinpainting.training.modules.pix2pixhd import ResnetBlock
from dscribe.saicinpainting.evaluation.refinement import (
    _infer,  # noqa
